...
def extract_data(existing_titles):
    ...
    all_data = []
    urls = [
        'https://ncscampeche.com/opiniones/?qtajax=true'
    ]
        ...
        try:
            ...
            for article in articles:
                ...
                try:
                    ...
                    title = title_tag[1].find('strong').text.strip() if len(title_tag) > 1 and title_tag[1].find('strong') else "No title found"
